...
- causes: TOP 3 원인. 각각 rank(1~3), title(15~25자), desc(60~110자, 수치+발표주체 포함), tags(최대 3개), impact(섹터·지수 등락폭 5~15자), evidence(근거 건수 1~6 정수), sources(필수 1~3개).
- sources(필수): 위 [영문 주요 뉴스 헤드라인]·[한국 금융 뉴스 헤드라인] 목록에서 그 원인을 가장 잘 뒷받침하는 항목을 1~3개 골라 {headline, source}로 복사. headline은 한 글자도 바꾸지 말고 그대로, source는 [...]에 적힌 매체명 그대로. 입력 목록에 없는 출처는 절대 만들지 말 것.
...
- causes: TOP 3 원인. 각각 rank(1~3), title(15~25자), desc(60~110자, 수치+발표주체 포함), tags(최대 3개), impact(섹터·지수 등락폭 5~15자), evidence(근거 건수 1~6 정수), sources(필수 1~3개).
- sources(필수): 위 [한국 시장 뉴스 헤드라인] 목록에서 그 원인을 가장 잘 뒷받침하는 항목을 1~3개 골라 {headline, source}로 복사. headline은 한 글자도 바꾸지 말고 그대로, source는 [...]에 적힌 매체명 그대로. 입력 목록에 없는 출처는 절대 만들지 말 것.`;
}
...
- causes: TOP 3 포인트. 각각 rank(1~3), title(15~25자), desc(60~110자, 수치+일정 포함), tags(최대 3개), impact(예상 임팩트 5~15자), evidence(근거 건수 1~6 정수), sources(필수 1~3개).
- sources(필수): 위 [영문 주요 뉴스 헤드라인]·[한국 금융 뉴스 헤드라인] 목록에서 그 포인트를 가장 잘 뒷받침하는 항목을 1~3개 골라 {headline, source}로 복사. headline은 한 글자도 바꾸지 말고 그대로, source는 [...]에 적힌 매체명 그대로. 입력 목록에 없는 출처는 절대 만들지 말 것.`;
}
