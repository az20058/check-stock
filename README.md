...
| `us_close` | KST 07:00 (UTC 22:00) | 미국 장 마감 후 — 어제 밤 결과 요약 |
| `kr_close` | KST 16:00 (UTC 07:00) | 한국 장 마감 후 — 오늘 한국 시장 요약 |

**주말 스킵**: 토요일 07:00 KST ~ 월요일 00:00 KST 사이 cron 호출은 자동 스킵 (장 휴무).
